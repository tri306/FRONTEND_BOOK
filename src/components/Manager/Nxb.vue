...
<template>
    <div class="Book">
        <h4 class="text-center m-2">Quản lý NXB</h4>
        <div class="container create-btn-container d-flex justify-content-end">
            <el-button type="primary" plain @click="navigatorToAdd">Thêm mới NXB</el-button>
        </div>
        <div class="container table-container">
            <el-table :data="filteredNxb" style="width: 100%">
                <el-table-column type="index" label=""> </el-table-column>
                <el-table-column label="Tên" prop="TenNxb"> </el-table-column>
                <el-table-column label="Địa chỉ" prop="Diachi"> </el-table-column>
                <el-table-column align="right">
                    <template #header>
                        <el-input v-model="search" size="small" placeholder="Nhập tên NXB để tìm kiếm" />
                    </template>
