...
<template>
  ...
  <div class="manager">
    <div class="d-flex justify-content-evenly text-center">
      <router-link
        to="/manager/borrow"
        class="navigation-link flex-grow-1 text-decoration-none text-black"
      >
        <div
          :class="`navigation ${
            routeBookCheck() == 'manager-borrow' ? 'active' : ''
          }`"
        >
          Quản lý mượn sách
        </div>
      ...
      >
        <div
          :class="`navigation ${
            routeBookCheck() == 'manager-book' ? 'active' : ''
          }`"
        >
          Quản lý sách
        </div>
      ...
      >
        <div
          :class="`navigation ${
            routeBookCheck() == 'manager-nxb' ? 'active' : ''
          }`"
        >
          Quản lý NXB
        </div>
